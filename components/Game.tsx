  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Test your environmental knowledge and earn EcoPoints!</p>
      </div>
      ...
      <Card>
        {gameState === 'start' && (
          <div className="text-center p-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6">Answer {quizQuestions.length} questions and see how much you know about sustainability.</p>
        ...
        {gameState === 'playing' && currentQuestion && (
          <div className="p-6">
            <div className="flex justify-between items-center mb-4">
                <p className="text-sm font-semibold text-blue-600 dark:text-blue-400">Question {currentQuestionIndex + 1} of {quizQuestions.length}</p>
        ...
        {gameState === 'finished' && (
           <div className="text-center p-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">You answered</p>
            <p className="text-5xl font-bold text-blue-600">{score} / {quizQuestions.length}</p>
            <p className="text-gray-500 dark:text-gray-400 mt-4 mb-2">correctly and earned</p>
