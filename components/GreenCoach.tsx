...
const GreenCoach: React.FC<GreenCoachProps> = ({ activities, dailyGoal }) => {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: "model",
      text: "Hi! I am your Green Coach. I can give you personalized advice based on your logged activities. Ask me anything, or get a proactive tip!",
    },
  ]);
  ...
  const getTip = async () => {
    ...
    try {
      const unlockedBadges = badges.filter((b) => b.isUnlocked(activities));
      const responseStream = generateProactiveTip(
        activities,
        unlockedBadges,
        dailyGoal
      );
      ...
      setMessages((prev) => [
        ...prev,
        { role: "model", text: "Sorry, I couldn't get a tip right now." },
      ]);
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700">
        <div className="mb-3 flex justify-center">
          <Button
            ...
            variant="secondary"
            size="sm"
            className="rounded-full !text-blue-600 dark:!text-blue-400 !bg-blue-100 dark:!bg-blue-900/50 hover:!bg-blue-200 dark:hover:!bg-blue-900"
          >
        ...
        <form onSubmit={handleSubmit} className="flex items-center gap-3">
          <input
            ...
            className="flex-1 px-4 py-2 bg-gray-100 dark:bg-gray-700 placeholder-gray-500 border border-gray-300 dark:border-gray-600 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500"
            disabled={isLoading}
          />
