...
export const AchievementIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const LeaderboardIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const LeafIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M17 8C8 10 5.9 16.17 3.82 21.34l1.89.66C7.5 17.5 9 13 17 12V8z" />
    <path d="M17 8a5 5 0 00-5-5h-1v2h1a3 3 0 013 3v1z" />
  </svg>
);
...
export const BoltIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M11 21h-1l1-7H7.5c-.58 0-.57-.32-.38-.66 1.96-3.47 4.51-8.03 4.88-8.34.37-.31.89-.29 1.25 0 .36.29 2.92 4.87 4.88 8.34.19.34.2.66-.38.66H13l-1 7z" />
  </svg>
);
...
export const FirstTimerIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const StreakIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M12.963 2.286a.75.75 0 00-1.071 1.052A6.75 6.75 0 0015.75 12c0 2.064-1.035 3.897-2.628 5.065a.75.75 0 00.94 1.182A8.25 8.25 0 0017.25 12c0-4.556-3.694-8.25-8.25-8.25-2.282 0-4.354.922-5.845 2.414a.75.75 0 001.06 1.06A6.75 6.75 0 0112.75 6c0 2.593-1.422 4.85-3.5 6.033a.75.75 0 00-.75 1.299A8.226 8.226 0 0012 19.5c.39 0 .77-.027 1.144-.08a.75.75 0 00.323-1.412A6.73 6.73 0 0112 18c-3.17 0-5.83-2.24-6.553-5.212a.75.75 0 00-1.42.338A8.25 8.25 0 0012 19.5a8.18 8.18 0 004.93-1.652.75.75 0 00.342-1.077 6.72 6.72 0 01-2.91-4.715.75.75 0 00-1.432.447 5.22 5.22 0 002.13 3.652.75.75 0 001.052-1.071 3.718 3.718 0 01-1.452-2.574.75.75 0 00-.958-1.011A6.733 6.733 0 018.25 12a6.75 6.75 0 016.75-6.75.75.75 0 00.213-1.464z"
      clipRule="evenodd"
    />
  </svg>
);

export const EcoPointsIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const SparklesIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.562L16.25 22.5l-.648-1.938a3.375 3.375 0 00-2.685-2.685L11.25 18l1.938-.648a3.375 3.375 0 002.685-2.685L16.25 13.5l.648 1.938a3.375 3.375 0 002.685 2.685L21 18l-1.938.648a3.375 3.375 0 00-2.685 2.685z"
    />
  </svg>
);

export const CalculatorIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M15.75 15.75V18m-7.5-6.75h.008v.008H8.25v-.008zm0 3h.008v.008H8.25v-.008zm0 3h.008v.008H8.25v-.008zm3-6h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm3-6h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zM4.5 6.75h15M4.5 12h15m-15 5.25h15M4.5 18h15"
    />
  </svg>
);
...
export const CheckCircleIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      fillRule="evenodd"
      d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-1.814a.75.75 0 10-1.06-1.06L10.939 12.81L9.47 11.34a.75.75 0 00-1.06 1.061l1.956 1.957a.75.75 0 001.06 0l3.472-3.473z"
      clipRule="evenodd"
    />
  </svg>
);
...
export const LocationMarkerIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      fillRule="evenodd"
      d="M12 2.25c-3.96 0-7.25 3.29-7.25 7.25 0 4.34 7.25 11.25 7.25 11.25s7.25-6.91 7.25-11.25C19.25 5.54 15.96 2.25 12 2.25zm0 12a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5z"
      clipRule="evenodd"
    />
  </svg>
);
...
export const TrainIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M12 2c-4 0-8 .5-8 4v9.5C4 17.43 5.57 19 7.5 19L6 20.5V21h12v-.5L16.5 19c1.93 0 3.5-1.57 3.5-3.5V6c0-3.5-4-4-8-4zM7.5 17c-.83 0-1.5-.67-1.5-1.5S6.67 14 7.5 14s1.5.67 1.5 1.5S8.33 17 7.5 17zm3.5-7H6V6h5v4zm2 0V6h5v4h-5zm3.5 7c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" />
  </svg>
);
...
export const ArrowLongRightIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const ShareIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.044.588.05H11.25a2.25 2.25 0 012.25 2.25v.015c0 .324.067.642.19.938m-3.906-4.155a2.25 2.25 0 012.25-2.25h1.5a2.25 2.25 0 012.25 2.25m-3.906 4.155L11.25 12m3.906 2.155c.123-.296.19-.614.19-.938V12a2.25 2.25 0 00-2.25-2.25h-1.5a2.25 2.25 0 00-2.25 2.25v.015c0 .324-.067.642-.19.938"
    />
  </svg>
);
